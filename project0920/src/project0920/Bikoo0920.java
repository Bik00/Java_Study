...
public class Bikoo0920 {

	public static void main(String[] args) {
		float a[]= new float[] {0,0,4,0,0,5};
		float b[]= new float[] {3,0,2,0,4,0};
		Polynomial A = new Polynomial(5, a);
		Polynomial B = new Polynomial(5, b);
		OperatePoly optPoly = new OperatePoly();
		Polynomial C = optPoly.minusPoly(A,B);
...
class OperatePoly{
	...
	public Polynomial minusPoly(Polynomial A, Polynomial B){
